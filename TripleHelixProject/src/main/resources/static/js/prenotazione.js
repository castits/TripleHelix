window.addEventListener("DOMContentLoaded", () => {
  ...
  let currentIndex = 0; // Tiene traccia dell'indice dell'elemento corrente del carosello
  ...
  /**
   * Funzione che gestisce l'aggiornamento dell'icona dell'hamburger in base allo stato del menu mobile.
   */
